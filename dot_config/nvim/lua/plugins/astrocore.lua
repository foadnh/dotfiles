  ...
  opts = {
    ...
    mappings = {
      ...
      t = {
        ...
        -- ["<C-Left>"] = { term_nav "h", desc = "Terminal left window navigation" },
        -- ["<C-Down>"] = { term_nav "j", desc = "Terminal down window navigation" },
        -- ["<C-Up>"] = { term_nav "k", desc = "Terminal up window navigation" },
        -- ["<C-Right>"] = { term_nav "l", desc = "Terminal right window navigation" },
        -- ["<C-H>"] = false,
        -- ["<C-J>"] = false,
        -- ["<C-K>"] = false,
        -- ["<C-L>"] = false,
